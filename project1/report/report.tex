...
\hspace{2mm}
\begin{minipage}[!t]{.45\linewidth}
To compute the expected value of $\mathbf{\tilde{y}}$, we employ the bootstrap method, which generates 
multiple samples for $\mathbf{\tilde{y}}$ and then calculates the mean of this distribution.
...
\begin{tcolorbox}
    Derivation of the expectation value and variance of $\boldsymbol{\hat{\beta}}$\\
\end{tcolorbox}
