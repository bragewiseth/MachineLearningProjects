...
We max out our testing range for $\lambda=10^{-5}$ which is realy close to zero, leading us to suspect that simple OLS is the best model for this data.

\begin{wrapfigure}{r}{0.4\textwidth}
    \begin{center}
        \includegraphics[width=0.4\textwidth]{../runsAndAdditions/R2andMSEOLSCrossval.png}
