...
\end{equation}
where $\mathbf{\beta}$ is the coefficients of the polynomial and $\mathbf{y}$ is the data.
This is a nice start, but we can do better. We can add a penalty term to the cost 
function, this is called ridge regression.
\begin{equation}
    \mathbf{\beta} = (X^T X + \lambda I)^{-1} X^T \mathbf{y}
\end{equation}
...
where $\lambda$ is a hyperparameter that we can tune to get a better fit. 
This is a nice start, but we can do better. We can add a penalty term to 
the cost function, this is called ridge regression.
\begin{equation}
    \mathbf{\beta} = (X^T X + \lambda I)^{-1} X^T \mathbf{y}
\end{equation}
where $\lambda$ is a hyperparameter that we can tune to get a better fit. This 
is a nice start, but we can do better. We can add a penalty term to the cost 
function, this is called ridge regression.
\begin{equation}
    \mathbf{\beta} = (X^T X + \lambda I)^{-1} X^T \mathbf{y}
\end{equation}
where $\lambda$ is a hyperparameter that we can tune to get a better fit. This is a
nice start, but we can do better. We can add a penalty term to the cost function, 
...
\subsection*{Math Behind the Confidence Interval section~\ref{sec:PaperPencil}}
