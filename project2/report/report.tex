...
\begin{abstract}%   <- trailing '%' for backward compatibility of .sty file
    ...
    By using a neural network, we achieved a classification accuracy of 96\% on the Wisconsin breast cancer
    dataset. With logistic regression, we achieved an accuracy of 94\%.
...
\begin{figure}
    ...
    \end{center}
    \caption{Feature correlation}\label{fig:}
\end{figure}


Wisconsin breast cancer dataset \& Boring regression data
...
always obvious what feature engineering is required to solve a problem. Neural networks can learn the relevant 
features from the data. Manually adding polynomial features is not a scalable solution for high-dimensional data,
whereas neural networks can learn arbitrarily complex functions. Adding polynomial featurer is also prone to 
bias problems.
\phantomsection%
